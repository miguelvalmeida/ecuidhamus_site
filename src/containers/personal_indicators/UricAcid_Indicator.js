...
class uricAcid_indicator extends Component {
    fetchData() {
        this.props.fetchPersonalUricAcid(this.props.date, this.props.date2);
...
const mapStateToProps = state => {
    return {
        personal_uric_acid: state.personal_indicators.personal_uric_acid,
...
const mapDispatchToProps = dispatch => {
    return {
        fetchPersonalUricAcid: (year1, year2) => dispatch(actions.fetchPersonalUricAcid(year1, year2)),
